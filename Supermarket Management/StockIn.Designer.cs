namespace Supermarket_Management
{
	partial class StockIn
	{
		...
		private void InitializeComponent()
		{
			...
			this.linkGen = new System.Windows.Forms.LinkLabel();
			...
			this.panel2.Controls.Add(this.linkProd);
			this.panel2.Controls.Add(this.linkGen);
			...
			this.labelID.Location = new System.Drawing.Point(577, 127);
			...
			// linkProd
			// 
			this.linkProd.Anchor = System.Windows.Forms.AnchorStyles.Top;
			this.linkProd.AutoSize = true;
			this.linkProd.LinkColor = System.Drawing.Color.DimGray;
			this.linkProd.Location = new System.Drawing.Point(127, 127);
			this.linkProd.Name = "linkProd";
			this.linkProd.Size = new System.Drawing.Size(204, 20);
			this.linkProd.TabIndex = 13;
			this.linkProd.TabStop = true;
			this.linkProd.Text = "[ Click to browse product ]";
			this.linkProd.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkProd_LinkClicked);
			// 
			// linkGen
			// 
			this.linkGen.Anchor = System.Windows.Forms.AnchorStyles.Top;
			this.linkGen.AutoSize = true;
			this.linkGen.LinkColor = System.Drawing.Color.DimGray;
			this.linkGen.Location = new System.Drawing.Point(292, 20);
			this.linkGen.Name = "linkGen";
			this.linkGen.Size = new System.Drawing.Size(99, 20);
			this.linkGen.TabIndex = 12;
			this.linkGen.TabStop = true;
			this.linkGen.Text = "[ Generate ]";
			this.linkGen.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkGen_LinkClicked);
			// 
			// dtStockIn
			// 
			...
			this.dgvInStockHistory.DefaultCellStyle = dataGridViewCellStyle8;
		...
		private System.Windows.Forms.LinkLabel linkGen;
