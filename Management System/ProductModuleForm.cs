...
namespace Management_System
{
	public partial class ProductModuleForm : Form
	{
		...
		private void btnSave_Click(object sender, EventArgs e)
		{
			try
			{
				if (MessageBox.Show("Are u sure to save this product?", "Saving Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
				{
		...
		private void btnUpdate_Click(object sender, EventArgs e)
		{
			try
			{
				...
				if (MessageBox.Show("Are u sure to update this product?", "Updating Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
				{
